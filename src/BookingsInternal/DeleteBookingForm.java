 ...
 */
public class DeleteBookingForm extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        b_delete = new javax.swing.JLabel();
        ...
        b_delete.setBackground(new java.awt.Color(0, 0, 153));
        b_delete.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        b_delete.setForeground(new java.awt.Color(255, 255, 255));
        b_delete.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        b_delete.setText("Delete");
        b_delete.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        jPanel1.add(b_delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 340, 110, 40));
    ...
    try {
        dbConnector dbc = new dbConnector();
        String bookingId = bkTable.getValueAt(selectedRow, 0).toString();

        ResultSet rs = dbc.getData("SELECT rm_id FROM tbl_bookings WHERE b_id = " + bookingId);
        if (rs.next()) {
            String roomId = rs.getString("rm_id");
    ...
    private void b_deleteMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_deleteMouseEntered
        b_delete.setBackground(hovercolor);
        b_delete.setForeground(foregroundcolor);
    ...
    private void b_deleteMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_deleteMouseExited
        b_delete.setBackground(exitcolor);
        b_delete.setForeground(exitforegroundcolor);
    }//GEN-LAST:event_b_deleteMouseExited


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel b_delete;
